    ...
    def index_dataset(self, dataset_id: str):
        ...
        documents.append(
            Document(
                ...
                metadata={"type": "schema", "dataset_id": dataset_id},
            )
        )
        ...
        documents.append(
            Document(
                ...
                metadata={"type": "statistics", "dataset_id": dataset_id},
            )
        )
    ...
    def index_model_insights(self, model_id: str):
        ...
        if hasattr(model, "feature_importances_"):
            ...
            if dataset:
                ...
                doc = Document(
                    page_content=f"Feature Importance for model {model_id}:\n{importance_text}",
                    metadata={"type": "feature_importance", "model_id": model_id},
                )
