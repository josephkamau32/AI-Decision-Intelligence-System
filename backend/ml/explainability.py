...
class ModelExplainer:
    ...
    def explain_instance(self, X: Union[pd.DataFrame, pd.Series, np.ndarray, Dict], feature_names: List[str] = None) -> Dict[str, Any]:
        """
    ...
    def generate_feature_importance_plot(self, X: pd.DataFrame, top_n: int = 10) -> str:
        ...
        importances = [item['importance'] for item in importance_data['feature_importance']]
