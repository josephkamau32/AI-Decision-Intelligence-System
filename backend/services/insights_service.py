    ...
    async def generate_model_insights(self, model_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            insights = {
                ...
                "prediction_distribution": {"class_0": 450, "class_1": 550},
            }
    ...
    def _calculate_data_quality(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "complete_percentage": (
                    (df.notna().all(axis=1).sum() / len(df) * 100) if len(df) > 0 else 0
                ),
            }
        except Exception as e:
    ...
    def _calculate_correlations(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        try:
            ...
            if len(numeric_df.columns) < 2:
                return {
                    "message": "Not enough numeric features for correlation analysis"
                }
    ...
    def _generate_dataset_recommendations(
        ...
        try:
            ...
            if not recommendations:
                recommendations.append(
                    "Dataset quality is good. Ready for analysis and modeling."
                )
