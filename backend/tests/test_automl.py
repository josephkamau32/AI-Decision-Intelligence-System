...
class TestAutoML:
    ...
    def regression_data(self):
        ...
        y = pd.Series(
            [1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5, 9.5, 10.5] * 3, name="target"
        )
        return X, y
    ...
    def test_fit_classification(self, classification_data):
        ...
        result = automl.fit(
            X, y, experiment_name="test_automl_cls", log_artifacts=False
        )
    ...
    def test_fit_regression(self, regression_data):
        ...
        result = automl.fit(
            X, y, experiment_name="test_automl_reg", log_artifacts=False
        )
    ...
    def test_predict_and_proba(self, classification_data):
        ...
        automl = AutoML(task_type="classification", test_size=0.2)
        automl.fit(
            X, y, experiment_name="test_automl_pred", use_cv=False, log_artifacts=False
        )
    ...
    def test_save_and_load_model(self, classification_data):
        ...
        automl.fit(
            X,
            y,
            experiment_name="test_automl_persist",
            use_cv=False,
            log_artifacts=False,
        )
