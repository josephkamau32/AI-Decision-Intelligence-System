...
dataset_size_bytes = Gauge(
    'dataset_size_bytes',
    'Size of uploaded dataset in bytes',
    ['dataset_id']
)
...
def track_training_metrics(model_type: str, task_type: str, duration: float, status: str, accuracy: float = None, model_id: str = None):
    """
...
def track_inference_metrics(model_id: str, duration: float, inference_type: str = 'single'):
    """
...
def track_drift_metrics(model_id: str, drift_detected: bool, drift_type: str = 'data', score: float = 0.0):
    """
