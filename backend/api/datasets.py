...
from ..schemas.dataset import DatasetUploadRequest, DatasetListResponse, PaginatedResponse
from ..services.dataset_service import dataset_service
from ..utils.validators import validate_file_extension, validate_file_size, validate_dataset_name, validate_pagination_params
...
async def list_datasets(
    ...
    if search:
        all_datasets = [
            ...
            if search.lower() in d.name.lower() or
