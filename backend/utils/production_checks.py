...
class ProductionValidator:
    ...
    def check_environment_variables(self, required_vars: List[str], optional_vars: List[str] = None):
    ...
    def check_security_settings(self, settings_obj):
        ...
        if hasattr(settings_obj, 'allowed_origins'):
            if "*" in settings_obj.allowed_origins and os.getenv('ENVIRONMENT') == 'production':
                self.results.append(ValidationResult(
                    passed=False,
